...
🌐 **Live Service**: [router.daydreams.systems](https://router.daydreams.systems)
...
- [API Reference](https://router.daydreams.systems/docs) - Complete endpoint documentation

## Example Applications

### Nanoservice (Paid AI Assistant)

The [nanoservice example](https://github.com/daydreamsai/daydreams/tree/main/examples/x402/nanoservice) demonstrates a complete AI service with x402 payments:
...
- Explore [Dreams SDK integration](./dreams-sdk) for TypeScript projects
- Learn about [x402 payments](https://www.x402.org/) for micropayment integration
- View [complete examples](https://github.com/daydreamsai/daydreams/tree/main/examples)
