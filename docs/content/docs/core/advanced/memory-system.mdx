...
title: Memory System
description:
  The DaydreamsAI unified memory architecture with providers, middleware, and
  multi-tier storage.
---

## Unified Memory Architecture

DaydreamsAI features a **unified memory system** that provides sophisticated
...
The new memory system consists of three main layers:
...
We've created comprehensive provider packages that follow the new architecture:
...
The new system includes significant performance optimizations:
...
This memory system transforms DaydreamsAI from a stateless framework into a
